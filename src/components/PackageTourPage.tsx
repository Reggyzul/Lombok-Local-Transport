...
Please inform availability and the booking procedure. Thank you!`;
  ...
  return (
    <div className="pt-24 pb-20 bg-slate-50 min-h-screen">
      {/* Header Banner */}
      <div className="bg-gradient-to-r from-emerald-800 via-emerald-700 to-teal-800 text-white py-12 px-4 sm:px-6 lg:px-8 shadow-md relative overflow-hidden mb-10">
        <div className="max-w-6xl mx-auto text-center space-y-3 relative z-10">
          <span className="inline-block bg-white/10 px-3 py-1 rounded-full border border-white/20 text-[11px] font-bold uppercase tracking-widest text-emerald-200">
            {t.pkg_tag}
          </span>
            ...
            >
              <div>
                ...
                <div className="relative h-48 overflow-hidden bg-slate-900">
                  ...
                  {/* Badge */}
                  <div className="absolute top-3 left-3 bg-emerald-600 text-white text-[10px] font-bold uppercase px-2.5 py-0.5 rounded-md shadow-sm">
                    {pkg.badge}
                  </div>
              ...
              <div className="p-5 pt-0">
                <button
                  ...
                  className="w-full bg-slate-900 hover:bg-emerald-600 text-white font-display font-bold text-xs uppercase py-3 px-4 rounded-xl shadow-xs transition-colors flex items-center justify-center gap-2 cursor-pointer"
                >
              ...
              <div className="relative bg-slate-900 text-white p-4 sm:p-5 shrink-0 border-b border-slate-800 z-20">
                ...
                <div className="space-y-1.5 pr-14">
                  <div className="flex flex-wrap items-center gap-2">
                    <span className="bg-emerald-600 text-white text-[10px] font-bold uppercase px-2.5 py-0.5 rounded shadow-xs">
                      ...
                      return (
                        ...
                        >
                          <div className="space-y-1.5">
                            <div className="flex items-start justify-between">
                              <div>
                                ...
                                <span className="text-[10px] font-bold text-emerald-800 bg-emerald-100 px-1.5 py-0.5 rounded mt-0.5 inline-block">
                                  {tier.capacity}
                                </span>
                              </div>
                              {isSelected && (
                          ...
                          <div className="mt-2.5 pt-1.5 border-t border-slate-200/80 flex items-center justify-between">
                            ...
                            <span className="font-display font-black text-xs sm:text-sm text-emerald-700">
              ...
              <div className="p-3.5 sm:p-4 bg-slate-900 text-white flex items-center justify-between gap-3 border-t border-slate-800 shrink-0 z-20">
                <div className="min-w-0">
                  ...
                  <span className="font-display font-bold text-xs text-white truncate block">
                    {selectedTier.busType} — <span className="text-emerald-400">{selectedTier.pricePerPerson}</span>
                  </span>
                </div>

                <button
                  onClick={() => handleWhatsAppBooking(selectedPackage, selectedTier)}
                  className="bg-emerald-600 hover:bg-emerald-700 text-white font-display font-bold text-xs uppercase py-2.5 px-4 sm:px-5 rounded-xl transition-colors flex items-center gap-1.5 cursor-pointer shrink-0 shadow-md"
                >
