...
export const CARS: Car[] = [
  // 1. TOYOTA AVANZA
  {
    ...
    includeList: [
      ...
      'AC Double Blower sejuk dan nyaman',
      'Interior bersih, wangi & terawat',
  ...
  // 2. TOYOTA INNOVA
  {
    ...
    includeList: [
      ...
      'AC Dingin merata ke semua baris',
  ...
  // 3. TOYOTA HIACE
  {
    ...
    includeList: [
      ...
      'Reclining seats & legroom ekstra luas',
      'Full AC Ducting dingin di setiap kursi',
      'Audio entertainment & USB charging ports',
...
export const TESTIMONIALS: TestimonialItem[] = [
  {
    ...
    textID: 'Pelayanan sangat memuaskan dari Lombok Local Transport! Unit Innova sangat bersih dan nyaman untuk perjalanan kami sekeluarga ke Sembalun dan Senaru. Driver sangat menguasai rute dan ramah!',
    rating: 5,
  ...
  },
  {
    ...
    carModelEN: 'Toyota Hiace Premio',
    carModelID: 'Toyota Hiace Premio',
    dateEN: 'July 2026',
    dateID: 'Juli 2026'
  },
  {
